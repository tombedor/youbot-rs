...
- for each repo:
    - TODO.md: A list of tasks. Each task has:
        ...
        - description: user-provided at creation time, describes what needs to be done
        - title: short label, AI-generated by CodingAgentSupervisor after the first session
...
- llm generates title, persists both
